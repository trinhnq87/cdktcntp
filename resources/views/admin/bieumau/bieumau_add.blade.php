...
@endif
<form action="{{ route('bieumau.store') }}" method="post">
	{{ csrf_field() }}
	<div class="form-group row">
		<label for="tenBieumau" class="col-md-3 col-form-label">Tên biểu mẫu</label>
		<input type="text" name="tenBieumau" id="tenBieumau" value="" class="col-md-6 form-control" required>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<input type="text" name="urlBieumau" id="urlBieumau" value="" class="col-md-6 form-control" required>
	</div>
